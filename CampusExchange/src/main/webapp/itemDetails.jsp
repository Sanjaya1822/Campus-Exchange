...
<div class="auth-container">
    ...
    <p>
        Status:
        <strong style="color:<%= "SOLD".equals(status) ? "red" : "green" %>">
            <%= status %>
        </strong>
    </p>
    ...
    %>
        ...
        <%
            ...
            while (rsReq.next()) {
                found = true;
        %>
                <p>📧 <%= rsReq.getString("buyer_email") %></p>
        <%
            }
        ...
        %>
            <form action="markSold" method="post" style="margin-top:20px;">
                ...
                <button type="submit" class="btn-primary" style="background:#444;">
                    Mark as Sold
                </button>
            </form>
        <%
